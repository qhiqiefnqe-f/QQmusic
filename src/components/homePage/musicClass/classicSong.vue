...
const transitionName = computed(() => {
  return classicSongStore.activeSet > classicSongStore.lastActiveSet
    ? 'slide-grow'
    : 'slide-shrink'
})
...
// 监听activeSet的变化
watch(
  () => classicSongStore.activeSet,
  (newVal, oldVal) => {
    classicSongStore.lastActiveSet = oldVal
...
<template>
  <div class="gallery">
    <transition :name="transitionName" mode="out-in">
      <div class="musicPart" :key="classicSongStore.activeSet">
        <div
          class="perMusic"
          v-for="image in classicSongStore.currentImagesSet"
          :key="image.id"
        >
          <div class="picture">
    ...
    <ul class="dots">
      <li
        v-for="n in classicSongStore.imagesCount"
        :key="n"
        @click="classicSongStore.changeImageSetByIndex(n)"
        :class="{ active: n === classicSongStore.activeSet }"
      ></li>
    </ul>
  </div>
</template>
